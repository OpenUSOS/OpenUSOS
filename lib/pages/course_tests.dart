...
class CourseTestsState extends State<CourseTests> {
  ...
  late Future<void> _courseTestsFuture; //necessary because future builder makes repeated api calls otherwise
  ...
  void initState() {
    super.initState();
    _courseTestsFuture = _fetchGrades();
  }
